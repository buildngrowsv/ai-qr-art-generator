...
export const config = {
  ...
  matcher: ["/((?!api|vs|_next|_vercel|privacy|privacy-policy|terms|terms-of-service|refund-policy|refund|for|best|use-cases|get-started|.*\\.|blog|lp|testimonials|ai-.*).*)"],
};
